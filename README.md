...
[https://mitrandier.github.io/Aichatbot/](https://mitrandier.github.io/Aichatbot/)
...
Basic AI chatbot integrated into a webpage
Connected via **n8n webhook** to handle incoming messages
Uses a workflow to process user inputs and send responses from ChatGPT API
Minimal frontend design with HTML and some CSS for layout
Demonstrates the concept of integrating an AI assistant into a website

---

📍 The Process

This project was created as an **introductory exercise** to connect a chatbot to a web page.
...
4. Start interacting with the chatbot — responses are generated via ChatGPT API
